<div class="row">
    <div class="col-md-8">
        ...
        <form action="<?= base_url('Keuangan/i_pm') ?>" method="post" accept-charset="utf-8">
            <div class="form-group row">
                <label for="tgl_pm" class="col-md-3 col-form-label">Tanggal Pemasukan</label>
                <div class="col-md-6">
                    <div class="input-group">
                        <input type="date" name="tgl_pm" id="tgl_pm" class="form-control" autofocus value="<?= date("Y-m-d") ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <div class="input-group">
                        <input name="sumber" id="sumber" class="form-control" value="<?= set_value('sumber') ?>" />
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <div class="input-group">
                        <input name="nama_pm" id="nama_pm" class="form-control" value="<?= set_value('nama_pm') ?>" />
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <input name="jml_pm" id="jml_pm" class="form-control" value="<?= set_value('jml_pm') ?>" />
