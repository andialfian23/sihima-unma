<div class="row">
    <div class="col-md-8">
        ...
        <form action="<?= base_url('Keuangan/i_pk') ?>" method="post" accept-charset="utf-8">
            <div class="form-group row">
                <label for="tgl_pk" class="col-md-3 col-form-label">Tanggal Pengeluaran</label>
                <div class="col-md-6">
                    <div class="input-group">
                        <input type="date" name="tgl_pk" id="tgl_pk" class="form-control" autofocus value="<?= date("Y-m-d") ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <div class="input-group">
                        <input name="nama_pk" id="nama_pk" class="form-control" value="<?= set_value('nama_pk') ?>" />
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <input name="jml_pk" id="jml_pk" class="form-control" value="<?= set_value('jml_pk') ?>" />
