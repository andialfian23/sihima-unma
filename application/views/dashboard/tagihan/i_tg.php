<div class="row">
    <div class="col-md-10">
        ...
        <form action="<?= base_url('Tagihan/i_tg') ?>" method="post" accept-charset="utf-8">
            <div class="form-group row">
                <label for="created_at" class="col-md-3 col-form-label">Tanggal Dibuat</label>
                <div class="col-md-6">
                    <div class="input-group">
                        <input type="date" name="created_at" id="created_at" class="form-control" autofocus value="<?= date("Y-m-d") ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <div class="input-group">
                        <input name="nama_tagihan" id="nama_tagihan" class="form-control" />
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <input name="jml_tagihan" id="jml_tagihan" class="form-control" />
