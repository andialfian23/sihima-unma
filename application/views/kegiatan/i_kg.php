...
<script>
    ...
    function submit_posts() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // setTimeout(function() {
                //     window.location.assign("<?= base_url('Kegiatan/sekarang') ?>");
                // }, 2000);
                toastr.success(response);
                setTimeout(function() {
                    window.location.replace("<?= base_url('Kegiatan/sekarang') ?>");
                }, 2000);
            }
        });
    };
    ...
    function setMulaiAbsen() {
        $('#mulaiAbsen').val($('#mulai').val());
    }

    function setSelesaiAbsen() {
        $('#selesaiAbsen').val($('#selesai').val());
    }
</script>
        ...
        <div class="card border-primary mb-1">
            <div class="card-body text-dark">
                ...
                <div class="input-group">
                    <input name="nama_kegiatan" id="nama_kegiatan" class="form-control" autofocus />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card border-primary mb-1">
            <div class="card-body text-dark">
                ...
                <div class="input-group row">
                    ...
                    <div class="col-md-8">
                        <input type="datetime-local" name="mulai" class="form-control" id="mulai" value="" onchange="return setMulaiAbsen()">
                    </div>
                </div>
                <div class="input-group row">
                    <label for="selesai" class="col-md-4 col-form-label">Selesai</label>
                    <div class="col-md-8">
                        <input type="datetime-local" name="selesai" class="form-control" id="selesai" value="" onchange="return setSelesaiAbsen()">
                    </div>
                </div>
                <div class="input-group row my-1">
                    <div class="col-md-12 col-sm-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input tombolCek" value="1" id="is_active" name="is_active" checked onclick="return is_active()">
                            <label class="custom-control-label" for="is_active">Sesuaikan waktu absensi dengan waktu kegiatan</label>
                        </div>
                    </div>
                </div>
                <div id="formAbsen" class="mt-2 d-none">
                    <h5 class="card-title">Waktu Absensi</h5>
                    <div class="input-group row">
                        <label for="mulaiAbsen" class="col-md-4 col-form-label">Mulai</label>
                        <div class="col-md-8">
                            <input type="datetime-local" name="mulaiAbsen" class="form-control" id="mulaiAbsen" value="">
                        </div>
                    </div>
                    <div class="input-group row">
                        <label for="selesaiAbsen" class="col-md-4 col-form-label">Selesai</label>
                        <div class="col-md-8">
                            <input type="datetime-local" name="selesaiAbsen" class="form-control" id="selesaiAbsen" value="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-8 col-sm-12">
        <div class="card border-primary mb-1">
            <div class="card-body text-dark">
                ...
                <div class="input-group">
                    <input name="tempat" id="tempat" class="form-control" value="<?= set_value('tempat') ?>" />
                </div>
