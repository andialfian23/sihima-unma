<div class="row">
    <div class="col-md-6">
        ...
        <form action="<?= base_url('Admin/e_jabatan/' . $col['id_jabatan']) ?>" method="post" accept-charset="utf-8">
            <div class="form-group row">
                <label for="jabatan" class="col-md-4 col-form-label">Nama Jabatan</label>
                <div class="col-md-8">
                    <div class="input-group">
                        <input type="text" name="jabatan" id="jabatan" class="form-control" autofocus value="<?= $col['jabatan'] ?>">
                ...
                <div class="col-md-8">
                    <div class="input-group">
                        <select name="level" id="level" class="form-control">
                            <?php
                            $role = $this->db->get_where('t_role', ['level' => $col['level']])->row_array()['role'];
                            ?>
                            <option value="<?= $col['level'] ?>" hidden><?= $role ?></option>
                            <?php
