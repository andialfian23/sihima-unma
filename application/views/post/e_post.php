<script src="https://cdn.tiny.cloud/1/ykyeg2r4mx1ljcl808m3gojhw7qecwai4mlnkg0tff5h7cow/tinymce/5/tinymce.min.js"></script>
<script>
    tinymce.init({
        ...
        images_upload_handler: function(blobInfo, success, failure) {
            ...
            xhr.open('POST', '<?= base_url('Post/images_upload') ?>');
            xhr.onload = function() {
                if (xhr.status != 200) {
    ...
    function submit_posts() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response == '1') {
                    toastr.success("Postingan berhasil di ubah!!!");
                    setTimeout(function() {
